  ...
  var e = {
      ...
      721: (e, t, s) => {
        ...
        (v = d),
          (d = {
            ...v,
            get: (e, t, s) => _(e, t) || v.get(e, t, s),
            has: (e, t) => !!_(e, t) || v.has(e, t),
          }),
          s(550);
        ...
        class x {
          ...
          async expireEntries(e, t) {
            ...
            const i = [];
            for (const e of n) await s.delete(b, e.id), i.push(e.url);
            return i;
          }
          _getId(e) {
      ...
      86: (e, t, s) => {
        ...
        function c(e) {
          ...
          return a.searchParams.set(i, t), { cacheKey: a.href, url: r.href };
        }
        class o {
          constructor() {
            (this.updatedURLs = []),
          ...
          _useDefaultCacheabilityPluginIfNeeded() {
            ...
            for (const [s, a] of this.plugins.entries())
              a !== d.copyRedirectedCacheableResponsesPlugin &&
                (a === d.defaultPrecacheCacheabilityPlugin && (e = s),
                a.cacheWillUpdate && t++);
            0 === t
  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(679),
        ...
        a = s(162).CacheFirst,
        n = s(615).registerRoute,
        r = s(819).CacheableResponsePlugin,
        i = s(65).ExpirationPlugin;
      (0, s(796).precacheAndRoute)([
        { revision: "9665f970878f1ee5fed050cd0b491835", url: "index.html" },
        {
        ...
        { revision: "f85ad6e80c1d8dafd2899a5e577c683e", url: "main.bundle.js" },
        {
          revision: "4e0e34f265fae8f33b01b27ae29d9d6f",
      ...
      t({ urls: ["/index.html", "/"], strategy: c }),
        ...
        n(function (e) {
          ...
          plugins: [
            new r({ statuses: [0, 200] }),
            new i({ maxEntries: 60, maxAgeSeconds: 2592e3 }),
          ],
        }));
    })();
})();
