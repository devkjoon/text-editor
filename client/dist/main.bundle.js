...
(() => {
          ...
          function S(n, t, e) {
            ...
            return function (o, i) {
              ...
              for (e.method = o, e.arg = i; ; ) {
                ...
                if ("normal" === s.type) {
                  if (
                    ((r = e.done ? "completed" : "suspendedYield"), s.arg === h)
                  )
                    continue;
            ...
            (t.mark = function (n) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((n.__proto__ = g), f(n, l, "GeneratorFunction")),
            ...
            (I.prototype = {
              ...
              finish: function (n) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                  ...
                  if (e.finallyLoc === n)
                    return this.complete(e.completion, e.afterLoc), L(e), h;
                }
              },
              catch: function (n) {
                for (var t = this.tryEntries.length - 1; t >= 0; --t) {
  ...
  (e.n = (n) => {
    ...
    (() => {
      ...
      var g = e(687),
        m = e.n(g);
      const b = (n, t) => t.some((t) => n instanceof t);
      let w, x;
      const k = new WeakMap(),
        S = new WeakMap(),
        E = new WeakMap(),
      ...
      let I = {
        get(n, t, e) {
          if (n instanceof IDBTransaction) {
            if ("done" === t) return S.get(n);
            if ("objectStoreNames" === t) return n.objectStoreNames || E.get(n);
            if ("store" === t)
        ...
        return "function" == typeof n
          ? (t = n) !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...n) {
                  return t.apply(T(this), n), O(k.get(this));
                }
              : function (...n) {
                  return O(t.apply(T(this), n));
                }
            : function (n, ...e) {
                const r = t.call(T(this), n, ...e);
                return E.set(r, n.sort ? n.sort() : [n]), O(r);
              }
      ...
      function O(n) {
        ...
        const t = P(n);
        return t !== n && (j.set(n, t), L.set(t, n)), t;
      }
      const T = (n) => L.get(n);
      function M(
        n,
        ...
        return (
          r &&
            a.addEventListener("upgradeneeded", (n) => {
              r(O(a.result), n.oldVersion, n.newVersion, O(a.transaction));
            }),
      ...
      (W = I),
        (I = {
          ...W,
          get: (n, t, e) => N(n, t) || W.get(n, t, e),
          has: (n, t) => !!N(n, t) || W.has(n, t),
        });
      var A = (function () {
          var n = y(
            m().mark(function n() {
            ...
            m().mark(function n(t) {
              ...
              return m().wrap(function (n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (n.next = 2), M("jate", 1);
                    case 2:
                      return (
                        (e = n.sent),
                        (r = e.transaction("jate", "readwrite")),
                        (o = r.objectStore("jate")),
                        (i = o.put({ id: 1, value: t })),
                        (n.next = 8),
                        i
                      );
                    case 8:
                ...
                for (;;)
                  switch ((n.prev = n.next)) {
                    ...
                    case 8:
                      return (
                        (a = n.sent),
                        n.abrupt("return", null == a ? void 0 : a.value)
                      );
                    case 10:
                    case "end":
                      return n.stop();
      ...
      var F = h(function n() {
          ...
          (this.editor = CodeMirror(document.querySelector("#main"), {
            ...
            this.editor.on("blur", function () {
              console.log("The editor has lost focus"),
                R(localStorage.getItem("content"));
            });
        }),
        G = e(379),
        z = e.n(G),
        ...
        nn = e(402),
        tn = {};
      (tn.styleTagTransform = X()),
        (tn.setAttributes = Y()),
        (tn.insert = K().bind(null, "head")),
        (tn.domAPI = H()),
        (tn.insertStyleElement = J()),
        z()(nn.Z, tn),
        nn.Z && nn.Z.locals && nn.Z.locals;
      var en,
        rn = document.querySelector("#main");
      (rn.innerHTML = ""),
        void 0 === new F() &&
          ((en = document.createElement("div")).classList.add("spinner"),
          (en.innerHTML =
